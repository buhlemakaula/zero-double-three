...
const ICONS = {
  ...
  callout: 'M12 21s-7-5.2-7-11a7 7 0 0114 0c0 5.8-7 11-7 11zM12 8a2 2 0 100 4 2 2 0 000-4z',
}
...
export default function Policies({ settings }) {
  ...
  const cols = [
    ...
    },
    {
      ...
      body: (
        <>
          After <strong className="font-semibold">10 minutes</strong> the
          appointment is cancelled (no additional charges) and the deposit is
          not refunded. Please try to arrive earlier to keep your slot.
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <>
          Minimum <strong className="font-semibold">3 people</strong>. The client
          covers transport both ways; I organise my own travel at Bolt rates.
        </>
      ),
    },
  ]
