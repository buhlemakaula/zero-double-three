    ...
    <footer className="bg-paper py-16">
      <div className="shell">
        <div className="flex flex-col items-center gap-8 text-center">
          ...
          <p className="font-serif text-2xl italic text-ink/70">Own Your Crown.</p>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            {b.facebook_url && (
              <a href={b.facebook_url} target="_blank" rel="noopener noreferrer" className="pill pill-outline">
                Facebook
              </a>
            )}
