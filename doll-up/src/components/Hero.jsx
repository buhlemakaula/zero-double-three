      ...
      <div className="shell grid items-center gap-8 pb-4 md:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="animate-fade-up">
          ...
          <p className="mt-6 max-w-md text-[15px] leading-relaxed text-ink/70">
            Braids, cornrows, styling and nail art at Doll Up in Pietermaritzburg.
            Neat, gentle hands for the whole family, booked online in a few taps.
          </p>
        ...
        <div className="relative mx-auto w-full max-w-sm md:max-w-none">
          ...
          <img
            src="/photos/hero.jpg"
            alt="Doll Up Hair & Nail Art — braids, cornrows and nail art in Pietermaritzburg."
